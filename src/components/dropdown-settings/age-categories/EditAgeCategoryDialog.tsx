...
interface EditAgeCategoryDialogProps {
  open: boolean
...
export const EditAgeCategoryDialog = ({ 
  open, 
  onOpenChange, 
  category 
}: EditAgeCategoryDialogProps) => {
  ...
  const mutation = useAgeCategoryUpdateMutation()
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Modifier la catégorie d'âge</DialogTitle>
        </DialogHeader>
        <Form {...form}>
